...
public:
    ...
    {
        mpContextWidth.disposeAndClear();
        mpContextHeight.disposeAndClear();
        mpTilePosX.disposeAndClear();
        mpTilePosY.disposeAndClear();
        mpTileWidth.disposeAndClear();
        mpTileHeight.disposeAndClear();
        mpImage.disposeAndClear();
        ModalDialog::dispose();
    }
